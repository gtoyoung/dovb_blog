...
import plusImg from "public/img/plus.png";
...
export const TaskMain = () => {
  ...
  const onDragEnd = useCallback(
    (result: DropResult) => {
      ...
      if (startColumn === finishColumn) {
        ...
        db.updateTaskIndex(user.uid, startColumn.id, finishColumn.id, newColumn.taskIds, null).then(() => {
          setData(newData);
        });
      } else {
  ...
  const deleteColumn = (columnId: string) => {
    ...
    const newColumnOrder = data.columnOrder.filter((id) => id !== columnId) as string[];
          ...
          {(provided) => (
            <Container {...provided.droppableProps} ref={provided.innerRef}>
              ...
              >
                ...
                >
                  <Image src={plusImg} width={100} height={10} alt="" />
                </a>
              </div>
              <div
                style={{
                ...
                onDragOver={(e) => {
                  e.preventDefault();
                  document.getElementById("trash-zone").style.backgroundImage = "url(/img/recycle-bin.png)";
                }}
                onDragLeave={() => {
                  document.getElementById("trash-zone").style.backgroundImage = "url(/img/bin.png)";
                  return false;
                }}
                onDrop={(e) => {
                  e.preventDefault();
